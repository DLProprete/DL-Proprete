  ...
  return (
    <div className="space-y-4">
      ...
      <form method="get" className="flex flex-wrap items-end gap-3 text-sm">
        <div>
          <label htmlFor="userId" className="block text-xs text-zinc-500">
            Agent
          </label>
          <select
            id="userId"
        ...
        <div>
          <label htmlFor="siteId" className="block text-xs text-zinc-500">
            Site
          </label>
          <select
            id="siteId"
      ...
      <form action={validateSelectedAction} className="space-y-2">
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            ...
            {rows.length === 0 && (
              <tr>
                <td colSpan={9} className="py-4 text-zinc-400">
